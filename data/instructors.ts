...
export const MOCK_INSTRUCTORS_DATA: InstructorProfile[] = [
  {
    ...
    phone: '0722 999 888',
    bio: 'Pasionat de Bachata de peste 5 ani, Robert aduce energie și tehnică în fiecare oră.',
    specialization: 'Bachata Sensual & Moderna',
    socialMedia: { instagram: '@robert.dance' },
  ...
  },
  {
    ...
    phone: '0777 444 555',
    bio: 'Specialistă în Lady Styling, Agata pune accent pe eleganță și fluiditate.',
    specialization: 'Lady Styling & Bachata',
    socialMedia: { instagram: '@agata.dance' },
  ...
  },
  {
      ...
      phone: '0755 111 222',
      bio: 'Salsa este viața lui, aduce ritm și tehnică în fiecare oră.',
      specialization: 'Salsa On1',
      socialMedia: { instagram: '@adrian.dance' },
  ...
  },
  {
      ...
      phone: '0700 111 222',
      bio: 'Pasionată de Salsa, Andreea aduce energie și bucurie în fiecare oră.',
      specialization: 'Salsa',
      socialMedia: { instagram: '@andreea.dance' },
      styles: [DanceStyle.SALSA],
      levels: [SkillLevel.BEGINNER, SkillLevel.INTERMEDIATE],
      status: 'active',
      joinDate: '2023-01-10',
  ...
  },
  {
      ...
      phone: '0733 555 111',
      bio: 'Fondator Ginga, expert în Kizomba cu o experiență vastă în dansul social.',
      specialization: 'Kizomba',
      socialMedia: { instagram: '@marius.vilaia' },
  ...
  },
  {
      ...
      phone: '0700 333 444',
      bio: 'Diana aduce o notă de eleganță și tehnică în cursurile de Kizomba.',
      specialization: 'Kizomba',
      socialMedia: { instagram: '@diana.dance' },
      styles: [DanceStyle.KIZOMBA],
      levels: [SkillLevel.BEGINNER, SkillLevel.INTERMEDIATE],
      status: 'active',
      joinDate: '2021-01-01',
  ...
  },
  {
      ...
      phone: '0700 888 777',
      bio: 'Pasionat de Bachata, Marius Coman aduce energie și tehnică în fiecare oră.',
      specialization: 'Bachata',
      socialMedia: { instagram: '@marius.coman' },
      styles: [DanceStyle.BACHATA],
  ...
  },
  {
      ...
      phone: '0700 666 555',
      bio: 'Andra aduce o notă de eleganță și tehnică în cursurile de Bachata.',
      specialization: 'Bachata',
      socialMedia: { instagram: '@andra.dance' },
      styles: [DanceStyle.BACHATA],
      levels: [SkillLevel.BEGINNER, SkillLevel.IMPROVERS, SkillLevel.INTERMEDIATE],
      status: 'active',
      joinDate: '2022-01-01',
  ...
  },
  {
      ...
      phone: '0700 444 333',
      bio: 'Pasionat de Salsa, Adelin aduce energie și bucurie în fiecare oră.',
      specialization: 'Salsa',
      socialMedia: { instagram: '@adelin.dance' },
      styles: [DanceStyle.SALSA],
  ...
  },
  {
      ...
      phone: '0700 222 111',
      bio: 'Laura aduce o notă de eleganță și tehnică în cursurile de Salsa.',
      specialization: 'Salsa',
      socialMedia: { instagram: '@laura.dance' },
      styles: [DanceStyle.SALSA],
      levels: [SkillLevel.BEGINNER],
      status: 'active',
      joinDate: '2023-06-01',
